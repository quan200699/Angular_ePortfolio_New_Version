...
const routes = [
    {
        ...
        children: [
            {
                path: 'portfolio',
                loadChildren: () => Promise.all(/*! import() | portfolio-portfolio-module */[__webpack_require__.e("default~portfolio-portfolio-module~student-student-module"), __webpack_require__.e("portfolio-portfolio-module")]).then(__webpack_require__.bind(null, /*! ./portfolio/portfolio.module */ "./src/app/portfolio/portfolio.module.ts")).then(module => module.PortfolioModule)
            },
            {
                path: 'classes',
            ...
            {
                path: 'lectures',
                loadChildren: () => Promise.all(/*! import() | lecture-lecture-module */[__webpack_require__.e("common"), __webpack_require__.e("lecture-lecture-module")]).then(__webpack_require__.bind(null, /*! ./lecture/lecture.module */ "./src/app/lecture/lecture.module.ts")).then(module => module.LectureModule)
            },
            {
                path: 'students',
                loadChildren: () => Promise.all(/*! import() | student-student-module */[__webpack_require__.e("default~portfolio-portfolio-module~student-student-module"), __webpack_require__.e("common"), __webpack_require__.e("student-student-module")]).then(__webpack_require__.bind(null, /*! ./student/student.module */ "./src/app/student/student.module.ts")).then(module => module.StudentModule)
            },
            {
                path: 'templates',
                loadChildren: () => __webpack_require__.e(/*! import() | template-template-module */ "template-template-module").then(__webpack_require__.bind(null, /*! ./template/template.module */ "./src/app/template/template.module.ts")).then(module => module.TemplateModule)
            },
            {
                path: 'outcomes',
            ...
            {
                path: 'evaluations',
                loadChildren: () => Promise.all(/*! import() | evaluations-evaluations-module */[__webpack_require__.e("common"), __webpack_require__.e("evaluations-evaluations-module")]).then(__webpack_require__.bind(null, /*! ./evaluations/evaluations.module */ "./src/app/evaluations/evaluations.module.ts")).then(module => module.EvaluationsModule)
            },
        ]
    },
    {
...
/* harmony import */ var _helper_jwt_interceptor__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./helper/jwt-interceptor */ "./src/app/helper/jwt-interceptor.ts");
/* harmony import */ var _helper_error_interceptor__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./helper/error-interceptor */ "./src/app/helper/error-interceptor.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        providers: [
            { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HTTP_INTERCEPTORS"], useClass: _helper_jwt_interceptor__WEBPACK_IMPORTED_MODULE_8__["JwtInterceptor"], multi: true },
            { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HTTP_INTERCEPTORS"], useClass: _helper_error_interceptor__WEBPACK_IMPORTED_MODULE_9__["ErrorInterceptor"], multi: true }
        ],
...
let LoginComponent = class LoginComponent {
    constructor(activatedRoute, router, authenticationService, notificationService) {
