...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["portfolio-portfolio-module"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppPortfolioPortfolioComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<button (click)=\"generatePdf('open')\">Open PDF</button>\r\n";
    /***/
  },
  ...
  /***/
  function srcAppPortfolioPortfolioRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPortfolioPortfolioComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppPortfolioPortfolioComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var pdfmake_build_pdfmake_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! pdfmake/build/pdfmake.js */
    "./node_modules/pdfmake/build/pdfmake.js");
    /* harmony import */


    var pdfmake_build_pdfmake_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(pdfmake_build_pdfmake_js__WEBPACK_IMPORTED_MODULE_2__);
    /* harmony import */


    var pdfmake_build_vfs_fonts_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! pdfmake/build/vfs_fonts.js */
    "./node_modules/pdfmake/build/vfs_fonts.js");
    /* harmony import */


    var pdfmake_build_vfs_fonts_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(pdfmake_build_vfs_fonts_js__WEBPACK_IMPORTED_MODULE_3__);

    pdfmake_build_pdfmake_js__WEBPACK_IMPORTED_MODULE_2__["vfs"] = pdfmake_build_vfs_fonts_js__WEBPACK_IMPORTED_MODULE_3__["pdfMake"].vfs;
    ...
    var PortfolioComponent = /*#__PURE__*/function () {
      function PortfolioComponent() {
        ...
        this.buildPortfolioContent = function () {
          return [_this.buildPortfolioTitle('BOOTCAMP JAVA'), _this.buildPortfolioDescription(), _this.buildPortfolioInfo(), _this.buildPortfolioGeneralAssessment(), _this.buildPortfolioDetail()];
        };
        ...
        this.buildPortfolioInfo = function () {
          return {
            columns: [[{
        ...
        this.buildPortfolioGeneralAssessment = function () {
          var date = new Date();
          return [{
            text: '\nI. ĐÁNH GIÁ CHUNG\n' + '1. Mức độ đánh giá (3)\n',
            fontSize: 12,
        ...
        this.buildPortfolioDetail = function () {
          return [_this.buildPortfolioDetailedAssessment(), _this.buildPortfolioOutcome(), _this.buildPortfolioOnlineCourse(), _this.buildPortfolioAddendum(), _this.buildPortfolioProductTable(), _this.buildPortfolioNote()];
        };
        ...
        this.buildPortfolioOutcome = function () {
          return '';
        };
          ...
          return {
            table: {
              ...
              body: [[{
                ...
                fontSize: 12,
                bold: true
              }]].concat(_toConsumableArray(_this.onlineCourses.map(function (onlineCourse) {
                {
                  return [{
      ...
      _createClass(PortfolioComponent, [{
        ...
        key: "generatePdf",
        value: function generatePdf(action) {
          var documentDefinition = this.getDocumentDefinition();

          switch (action) {
            case 'open':
              pdfmake_build_pdfmake_js__WEBPACK_IMPORTED_MODULE_2__["createPdf"](documentDefinition).open();
              break;

            case 'print':
              pdfmake_build_pdfmake_js__WEBPACK_IMPORTED_MODULE_2__["createPdf"](documentDefinition).print();
              break;

            case 'download':
              pdfmake_build_pdfmake_js__WEBPACK_IMPORTED_MODULE_2__["createPdf"](documentDefinition).download();
              break;
    ...
    PortfolioComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./src/app/portfolio/portfolio.component.css"))["default"]]
    })], PortfolioComponent);
    /***/
  },
  ...
  function srcAppPortfolioPortfolioModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _portfolio_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./portfolio.component */
    "./src/app/portfolio/portfolio.component.ts");
    /* harmony import */
    ...
    PortfolioModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      imports: [_portfolio_routing_module__WEBPACK_IMPORTED_MODULE_3__["PortfolioRoutingModule"]]
    })], PortfolioModule);
    /***/
  }
}]);
